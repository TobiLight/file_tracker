...
export const Register = (): JSX.Element => {
    ...
    */
    ...
    const handleSubmit = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        RegisterHandler.mutate({ newUser: input, url: '/user/register/' }, {
            onError: (err: any) => {
                message.error(`${err}`)
                window.scrollTo(0, 0)
            },
            onSuccess: (data: any) => {
                ...
                setCheckbox(false)
                window.scrollTo(0, 0)
                message.success({ content: "Account created successfully!", key: 'registration' })
                // history.push("/login")
                setTimeout(() => {
        ...
        <MainLayout className="bg-gray-100">
            <div className="min-h-screen flex items-center mt-24 my-14">
                <div className="shadow-lg bg-white rounded w-9/12 sm:w-1/2 lg:w-3/5 mx-auto py-8 px-4">
                    <h1 className="text-2xl font-bold text-center mt-4 mb-10">Sign up</h1>
                    <form className="px-6">
                        ...
                        <div className="my-8 flex space-x-3 items-center text-sm">
                            <Chekcbox handleCheckboxChange={handleCheckbox} checked={checked} name={"t-and-c"} className="w-8 h-8" />
                        ...
                        <div>
                            <Button
                                ...
                                disabled={!checked || !input.password || !input?.password2 ? true : false}
